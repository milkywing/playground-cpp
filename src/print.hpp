...
#define PRINT_SFINAE_VALUE(x) \
  ...
  inline constexpr bool x##_v = x<T>::value;
    ...
    PRINT_SFINAE_VALUE(_if_impl_toString)
    ...
    struct _if_impl_stream_insert<T, std::void_t<decltype(std::declval<std::ostream&>() << std::declval<T const&>())>>
        : std::true_type {};
    PRINT_SFINAE_VALUE(_if_impl_stream_insert)
    ...
    PRINT_SFINAE_VALUE(_is_tuple_like)
    ...
    PRINT_SFINAE_VALUE(_is_optional)
    ...
    PRINT_SFINAE_VALUE(_is_variant)
    ...
    struct _is_iterable<
        ...
        : std::true_type {};
    PRINT_SFINAE_VALUE(_is_iterable)
